...
namespace Pd2TradeApi.Server.Data.Migrations
{
    ...
    [Migration("20201204212908_AddRunewordAndItemSocketModels")]
    partial class AddRunewordAndItemSocketModels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pd2TradeApi.Server.Models.DatabaseModels.ItemStat", b =>
                {
                    b.HasOne("Pd2TradeApi.Server.Models.DatabaseModels.Item", null)
                        .WithMany("DefaultStats")
                        .HasForeignKey("ItemId");

                    b.HasOne("Pd2TradeApi.Server.Models.DatabaseModels.ItemSocket", null)
                        .WithMany("Stats")
                        .HasForeignKey("ItemSocketId");
